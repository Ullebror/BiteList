...
export const addToFavorites = async (userId: string, recipeLabel: string, recipeUri: string) => {
...
export const removeFromFavorites = async (userId: string, recipeLabel: string) => {
    const favoriteRef = ref(db, `users/${userId}/favorites/${recipeLabel}`);
    try {
...
export const isRecipeFavorited = async (userId: string, recipeLabel: string) => {
    const favoriteRef = ref(db, `users/${userId}/favorites/${recipeLabel}`);
    try {
